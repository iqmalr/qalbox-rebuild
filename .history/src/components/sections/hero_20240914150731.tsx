...
export const Hero = () => {
  return (
    <div className="relative h-[300vh] bg-background opacity-70 text-white">
      <div className="bg-black absolute inset-0 left-0 top-[--header-height] w-full opacity-60 h-[200vh]">
        <img
