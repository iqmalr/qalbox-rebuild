  ...
  return (
    <motion.div animate={carouselVariant} className="bg-background pb-16 pt-4">
        ...
        <div className="sticky top-0 flex h-screen items-center">
          <div className="relative left-1/2 mb-5 flex -translate-x-1/2 gap-5">
            <motion.div
              ...
              className="aspect-[9/16] w-[60vw] shrink-0 overflow-clip rounded-2xl hover:opacity-30 md:aspect-video"
            >
              <img
            ...
            >
              ...
              <motion.div
                ...
                className="text-lg absolute bottom-0 left-0 flex w-full flex-col items-center gap-4 p-5 text-white md:flex-row md:justify-between md:gap-0"
              >
            ...
            <motion.div
              ...
              className="aspect-[9/16] w-[60vw] shrink-0 overflow-clip rounded-2xl md:aspect-video"
            >
              <img
                className="h-full w-full object-cover hover:brightness-75"
                src={movies[2].poster}
      ...
      <motion.div
        ...
        className="-mt-[calc((100vh-(260px*(16/16)))/2)] space-y-3 pt-4 md:-mt-[calc((100vh-(260px*(9/16)))/2)]"
      >
