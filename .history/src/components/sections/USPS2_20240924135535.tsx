...
export const USPS2 = () => {
  ...
  return (
    ...
    <CustomContainer className="bg-yellow-300 relative z-10 mt-36 space-y-12 font-bold text-white">
      <FadeIn className="bg-blue-200 flex flex-row items-center justify-center">
