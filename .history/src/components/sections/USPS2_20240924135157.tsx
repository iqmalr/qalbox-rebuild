...
export const USPS2 = () => {
  ...
  return (
    <CustomContainer className="bg-yellow-300 relative z-10 my-36 space-y-12 px-28 font-bold text-white">
      <FadeIn className="bg-blue-200 flex w-full flex-row justify-between">
      ...
      <FadeIn className="bg-blue-200 flex flex-row-reverse justify-between">
        <div className="bg-red-400 flex flex-col">
      ...
      <FadeIn className="bg-blue-200 flex flex-row justify-between">
        <div className="bg-red-400 flex flex-col">
