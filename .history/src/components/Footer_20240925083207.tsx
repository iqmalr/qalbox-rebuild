...
const Footer = () => {
  return (
    <motion.div
      ...
      className=""
    >
      <div className="mt-[50px] min-h-6"></div>
      <div className="text-grey mx-[50px] flex flex-col items-start justify-center gap-[20px] bg-background text-white md:mx-[100px] md:flex-row md:gap-[127px]">
